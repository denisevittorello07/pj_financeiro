...
class EmpresaDAO extends Conexao
{
    ...
    public function CadastrarEmpresa($nomeEmpr, $telefone, $endereco)
    {
        if (empty($nomeEmpr) || empty($telefone) || empty($endereco)) {
            return 0;
        } else {
    ...
    public function AlterarEmpresa($nomeEmpr, $telefone, $endereco, $idEmpresa)
    {
        if (empty($nomeEmpr) || empty($telefone) || empty($endereco) || empty($idEmpresa)) {
            return 0;
        } else {
            $conexao = parent::retornarConexao();
