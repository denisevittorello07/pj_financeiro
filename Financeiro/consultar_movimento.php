<?php
    ...
    if(isset($_POST['btnPesquisar'])){
        ...
        // Variável Array que vai receber a consulta executada via PDO!
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Consultar Movimentos Financeiros.</h2>
                        <h5>Aqui você pode realizar consultas de todos os seus movimentos financeiros realizados (fluxo de caixa).</h5>
